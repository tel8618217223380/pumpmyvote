...
?>
   <p>
   The Pro version allows voting by logged-in users only, fraud detection with cookie or off entirely, styling with CSS, etc. <a href="http://wealthynetizen.com/comment-rating-pro/">Comment Rating Pro</a>. <br/>
