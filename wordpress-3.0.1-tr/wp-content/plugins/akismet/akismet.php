...
Description: Akismet, yazılarınıza yapılan yorumların istenmeyen (spam) olup olmadıklarını kontrol eder. Bu servisi kullanmak için ücretsiz <a href="http://wordpress.com/api-keys/">WordPress.com API anahtarı</a> almanız gerekmektedir. Akismet'in yakaladığı spam yorumları "Yorumlar" menüsü altında inceleyebilirsiniz. Sitenizde Akismet istatistiklerini göstermek istiyorsanız temanıza <code>&lt;?php akismet_counter(); ?></code> kodunu yerleştirin. Ayrıca, <a href="http://wordpress.org/extend/plugins/stats/">WP Stats Eklentisi</a>ne de bakabilirsiniz.
Version: 2.3.0
Author: Automattic
