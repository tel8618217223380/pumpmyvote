<?php get_header(); ?>
	...
	<div id="container">	
		<div id="content">
			...
			<h1>Posts in <span><?php single_cat_title() ?></span></h1>
			<?php $categorydesc = category_description(); if ( !empty($categorydesc) ) echo apply_filters( 'archive_meta', '<div class="archiveMeta">' . $categorydesc . '</div>' ); ?>
