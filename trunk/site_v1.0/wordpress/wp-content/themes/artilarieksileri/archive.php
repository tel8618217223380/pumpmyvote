...
<?php if ( is_day() ) : ?>
			<h1><?php printf( __( 'Posts in <span>%s</span>', 'moov' ), get_the_time(get_option('date_format')) ) ?></h1>
<?php elseif ( is_month() ) : ?>
			<h1><?php printf( __( 'Posts in <span>%s</span>', 'moov' ), get_the_time('F Y') ) ?></h1>
<?php elseif ( is_year() ) : ?>
			<h1><?php printf( __( 'Posts in <span>%s</span>', 'moov' ), get_the_time('Y') ) ?></h1>
<?php elseif ( isset($_GET['paged']) && !empty($_GET['paged']) ) : ?>
			<h1><?php _e( 'Blog Archives', 'moov' ) ?></h1>
<?php endif; ?>
